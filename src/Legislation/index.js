        ...
        <div id="bottom-menu">
          <div id="buttons">
            <AddLegislation
              ...
              addLegislation={this.props.addLegislation}
            />
            <Update
              data={this.props.legislation}
              catagories={this.props.catagories}
              updatePopulated={this.props.updatePopulated}
              updateLegislation={this.props.updateLegislation}
            />
            <Delete
              data={this.props.legislation}
              deleteLegislation={this.props.deleteLegislation}
            />
            <DeleteBoth
              data={this.props.legislation}
              deleteBoth={this.props.deleteBoth}
            />
          </div>
